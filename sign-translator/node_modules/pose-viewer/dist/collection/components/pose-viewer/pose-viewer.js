...
export class PoseViewer {
    constructor() {
        this.renderer = 'canvas'; // Render in an SVG instead of a canvas
        // Dimensions
        this.width = null;
        this.height = null;
        ...
        this.autoplay = true;
        this.playbackRate = 1;
        this.currentTime = NaN; // This affects re-rendering
        this.duration = NaN;
        this.ended = false;
        this.paused = true;
        this.readyState = 0;
        ...
        return {
            "src": {
                ...
                "complexType": {
                    ...
                    "resolved": "Buffer<ArrayBufferLike> | string",
                    "references": {
                        "Buffer": {
                            "location": "global",
                            "id": "global::Buffer"
            ...
            "renderer": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "'canvas' | 'svg' | 'interactive'",
                    "resolved": "\"canvas\" | \"interactive\" | \"svg\"",
                    "references": {}
                },
                "required": false,
                "optional": false,
